...
DB_NAME = environ.get("DB_NAME", "FileBotz")
...
SHORTLINK_URL = environ.get("SHORTLINK_URL", "https://shrinkforearn.in/") # shortlink domain without https://
SHORTLINK_API = environ.get("SHORTLINK_API", "e6657b00e3f201daba5e3351cd611143ce9127a2") # shortlink api
...
WEBSITE_URL = environ.get("WEBSITE_URL", "https://arpitgavla121.blogspot.com/2024/08/adult-video_2.html") # For More Information Check Video On Yt - @Tech_VJ
